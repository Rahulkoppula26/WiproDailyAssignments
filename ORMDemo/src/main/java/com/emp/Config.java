...
public class Config {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan("com.emp"); // 2. scan all required components
	...
	public HibernateTransactionManager transactionManager() {
		...
		txManager.setSessionFactory(sessionFactory().getObject()); // to perform transaction it requires a session
																	// factory obj
		return txManager;
	}
